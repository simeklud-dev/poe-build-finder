...
- **Monetizace:** Google AdSense (Auto ads) přidáno 2026-07-18 — viz `POZNATKY.md`, sekce "Malé reklamy". Rozhodnutí "žádná monetizace" tímto padlo. Cookie consent banner pro EU/GDPR doplněn tentýž den — reklamní script se načítá až po odsouhlasení uživatelem.
